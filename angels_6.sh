...
ln -s rime.default.yaml ~/.config/ibus/rime/default.customyaml
mkdir -p ~/.config/fcitx5/rime/
ln -s rime.default.yaml ~/.config/fcitx5/rime/default.custom.yaml
ln -s fcitx5_profile ~/.config/fcitx5/profile
